...
from eval_utils_template_multiGPU_1 import read_split_data, train_one_epoch, evaluate
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if rank == 0:
            ...
            # torch.save(model.state_dict(), "./weights/model-current_1.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch-size', type=int, default=10)#10
    ...
    parser.add_argument('--weights', type=str, default=os.path.join(os.getcwd(), "model-current_5_0.8419.pth"),
                        help='initial weights path')
