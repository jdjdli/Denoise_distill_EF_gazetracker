...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_c=3, num_classes=1000,
                 ...
                 qk_scale=None, representation_size=None, distilled=False, drop_ratio=0.4,
                 attn_drop_ratio=0.5, drop_path_ratio=0., embed_layer=PatchEmbed, norm_layer=None,
                 act_layer=None):
        """
        Args:
    ...
    def forward_features(self, x, y, x_tmp, y_tmp):
        ...
        # nn.init.xavier_normal_(self.relation, gain=1)
        #
        # x = (x @ self.relation) @ x_tmp
        # x = abs(x - x_tmp)
        # extract cls token
        if self.dist_token is None:
    ...
    def forward(self, x, y, x_tmp, y_tmp):
        x = self.forward_features(x, y, x_tmp, y_tmp)
