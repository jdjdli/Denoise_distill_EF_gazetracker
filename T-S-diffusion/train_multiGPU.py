...
from utils_template_multiGPU import read_split_data, train_one_epoch, evaluate
...
def main(args):
    ...
    val_dataset = MyDataSet(frames_path=val_frames_path,
                            ...
                            template_voxels_path_1=val_template_voxels_path_1, template_frames_path_2=val_template_frames_path_2, template_voxels_path_2=val_template_voxels_path_2, template_frames_path_3=val_template_frames_path_3, template_voxels_path_3=val_template_voxels_path_3, template_frames_path_4=val_template_frames_path_4, template_voxels_path_4=val_template_voxels_path_4, template_frames_path_5=val_template_frames_path_5, template_voxels_path_5=val_template_voxels_path_5, position_label_path=val_position_label, position_weight_label_path=val_position_weight_label,
    ...
    teacher5 = teacher_model(num_classes=args.num_classes, has_logits=False).to(device)
    ...
    if os.path.exists(weights_path):
        ...
        weights_teacher5 = torch.load(args.middle_weights, map_location=device)
        ...
        teacher5_dict = {}
        for k,v in weights_teacher5.items():
            teacher5_dict[k[7:]] = v
        ...
        # del_keys = ['regressor_1.weight', 'regressor_1.bias', 'regressor_3.weight', 'regressor_3.bias', 'norm_input.weight', 'norm_input.bias'] if model.has_logits \
        #     else ['regressor_1.weight', 'regressor_1.bias', 'regressor_3.weight', 'regressor_3.bias', 'norm_input.weight', 'norm_input.bias']
        ...
        print(teacher5.load_state_dict(teacher5_dict, strict=False))
    ...
    for epoch in range(args.epochs):
        ...
        # validate
        val_loss, val_acc_num, val_mlp_loss = evaluate(model=model,
        ...
        if rank == 0:
            ...
            tb_writer.add_scalar(tags[1], train_acc_num, epoch)
            tb_writer.add_scalar(tags[2], train_mlp_loss, epoch)
            tb_writer.add_scalar(tags[3], val_loss, epoch)
            tb_writer.add_scalar(tags[4], val_acc_num, epoch)
            ...
            torch.save(model.state_dict(), "./weights/model-current_new.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch-size', type=int, default=6)#10
    ...
    parser.add_argument('--weights', type=str, default=os.path.join(os.getcwd(), "freepoints.pth"),
                        help='initial weights path')
    # parser.add_argument('--weights1', type=str, default=os.path.join(os.getcwd(), "mlp_weight-2.pth"),
    #                     help='initial weights path')
    ...
    parser.add_argument('--right_btm_weights', type=str, default=os.path.join(os.getcwd(), "right_btm_weight.pth"),
                        help='initial weights path')
    parser.add_argument('--middle_weights', type=str, default=os.path.join(os.getcwd(), "middle_weight.pth"),
                        help='initial weights path')
